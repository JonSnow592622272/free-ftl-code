...
<#list introspectedTable.primaryKeyColumns as primaryKey>
    ...
    public ${className} with${primaryKey.javaProperty?cap_first}(${primaryKey.fullyQualifiedJavaType.shortNameWithoutTypeArguments} ${primaryKey.javaProperty}) {
        this.${primaryKey.javaProperty} = ${primaryKey.javaProperty};
        return this;
    }
...
<#list introspectedTable.nonPrimaryKeyColumns as baseColumns>
    ...
    public ${className} with${baseColumns.javaProperty?cap_first}(${baseColumns.fullyQualifiedJavaType.shortNameWithoutTypeArguments} ${baseColumns.javaProperty}) {
        this.${baseColumns.javaProperty} = ${baseColumns.javaProperty};
        return this;
    }
