...
<mapper namespace="com.my.haha.${introspectedTable.tableConfiguration.domainObjectName}Mapper">

        <#--生成主键排在第一位，非主键排在后面，这里缩为一行是为了避免替换之后出现换行问题，注意！！！fileCreateType=2第一次生成会出现未换行的问题，再次生成一次即可恢复正常-->
